...
export class Menu3D extends Phaser.Scene {
    ...
    private playerWeaponsContainer: any
    ...
    private quitGameTxt: Phaser.GameObjects.Text
    ...
    private init(scene: Scene3D): void
    {
    ...
    private create(scene: Scene3D): void
    {   
    ...
    //page toggle
        ...
        this.inventory_nextBtnRight =  this.add.image(-1000, -1000, 'next_button').setInteractive().setScale(0.6)

            .on('pointerdown', ()=> this.changePage('inventory 2'))
            .on('pointerup', ()=> this.inventory_nextBtnRight.clearTint())
            .on('pointerover', ()=>this.inventory_nextBtnRight.setTintFill(0xff0000))
            .on('pointerout', ()=> this.inventory_nextBtnRight.clearTint());

        this.inventory_nextBtnLeft =  this.add.image(-1000, -1000, 'next_button').setInteractive().setScale(0.6)

            .on('pointerdown', ()=> this.changePage('inventory 1'))
            .on('pointerup', ()=> this.inventory_nextBtnLeft.clearTint())
            .on('pointerover', ()=> this.inventory_nextBtnLeft.setTintFill(0xff0000))
            .on('pointerout', ()=> this.inventory_nextBtnLeft.clearTint()).setFlipX(true);
    ...
    //quit game
        ...
        this.quitGameTxt = this.add.text(-1000, -1000, "Quit Game", {font: "30px Digitizer"}).setColor('#FFFF00').setStroke("#ff0000", 4).setShadow(2, 2, '#000000', 1, false).setInteractive().setDepth(101);

        this.quitGameTxt.on('pointerdown', ()=>{
            System.app.audio.play('ring', 1, false, this, 0);
            System.vibrate(20);
            this.quitGame.setVisible(true);
            this.quitGameTxt.setTintFill(0xff0000).setActive(true).setVisible(true);
            this.darkenOverlay.setVisible(true); 
            this.quitNo.setActive(true).setVisible(true);
            this.quitYes.setActive(true).setVisible(true);
            this.quitYes.on('pointerdown', ()=> this.exitGame());
                this.quitNo.on('pointerdown', ()=>{

                    System.app.audio.play('bloop1', 1, false, this, 0);
                    System.vibrate(20);
            ...
            .on('pointerup', ()=> this.quitGameTxt.clearTint())
            .on('pointerover', ()=>this.quitGameTxt.setTintFill(0xff0000))
            .on('pointerout', ()=>this.quitGameTxt.clearTint());
    ...
    //--------------------- assign textures of weapons
            ...
            this.weapon1 = scene.data['weapons'][0];
            this.weapon2 = scene.data['weapons'][1];
            this.weapon3 = scene.data['weapons'][2];
            this.weapon4 = scene.data['weapons'][3];
            this.weapon5 = scene.data['weapons'][4];
            this.weapon6 = scene.data['weapons'][5];
            this.weapon7 = scene.data['weapons'][6];
            this.weapon8 = scene.data['weapons'][7];
            this.weapon9 = scene.data['weapons'][8];
        ...
        //layer2
            this.playerWeaponsContainer = this.add.container();

            this.weapons2_1 = this.add.sprite(-1000, -1000, this.weapon1).setInteractive().setTintFill(0xff0000);	
            this.weapons2_2 = this.add.sprite(-1000, -1000, this.weapon2).setInteractive().setTintFill(0xff0000);	
            this.weapons2_3 = this.add.sprite(-1000, -1000, this.weapon3).setInteractive().setTintFill(0xff0000);	
            this.weapons2_4 = this.add.sprite(-1000, -1000, this.weapon4).setInteractive().setTintFill(0xff0000);	
            this.weapons2_5 = this.add.sprite(-1000, -1000, this.weapon5).setInteractive().setTintFill(0xff0000);	
            this.weapons2_6 = this.add.sprite(-1000, -1000, this.weapon6).setInteractive().setTintFill(0xff0000);	
            this.weapons2_7 = this.add.sprite(-1000, -1000, this.weapon7).setInteractive().setTintFill(0xff0000);	
            this.weapons2_8 = this.add.sprite(-1000, -1000, this.weapon8).setInteractive().setTintFill(0xff0000);	
            this.weapons2_9 = this.add.sprite(-1000, -1000, this.weapon9).setInteractive().setTintFill(0xff0000);	

            this.playerWeaponsContainer.add([
    ...
    //--------------------- assign textures of items
            ...
            this.item1 = scene.data['items'][0];
            this.item2 = scene.data['items'][1];
            this.item3 = scene.data['items'][2];
            this.item4 = scene.data['items'][3];
            this.item5 = scene.data['items'][4];
            this.item6 = scene.data['items'][5];
            this.item7 = scene.data['items'][6];
            this.item8 = scene.data['items'][7];
            this.item9 = scene.data['items'][8];
        ...
        //layer2
            ...
            this.item2_1 = this.add.sprite(-1000, -1000, this.item1).setInteractive().setTintFill(0xff0000);	
            this.item2_2 = this.add.sprite(-1000, -1000, this.item2).setInteractive().setTintFill(0xff0000);	
            this.item2_3 = this.add.sprite(-1000, -1000, this.item3).setInteractive().setTintFill(0xff0000);	
            this.item2_4 = this.add.sprite(-1000, -1000, this.item4).setInteractive().setTintFill(0xff0000);	
            this.item2_5 = this.add.sprite(-1000, -1000, this.item5).setInteractive().setTintFill(0xff0000);	
            this.item2_6 = this.add.sprite(-1000, -1000, this.item6).setInteractive().setTintFill(0xff0000);	
            this.item2_7 = this.add.sprite(-1000, -1000, this.item7).setInteractive().setTintFill(0xff0000);	
            this.item2_8 = this.add.sprite(-1000, -1000, this.item8).setInteractive().setTintFill(0xff0000);	
            this.item2_9 = this.add.sprite(-1000, -1000, this.item9).setInteractive().setTintFill(0xff0000);	
            ...
            scene.tweens.add({targets: this.item2_1, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_2, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_3, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_4, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_5, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_6, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_7, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
            scene.tweens.add({targets: this.item2_8, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true}); 
            scene.tweens.add({targets: this.item2_9, alpha: 0, duration: 2000, ease: 'Power1', repeat: -1, yoyo: true});
...
//// weapons
        ...
        this.weapons1.on('pointerdown', ()=> this.setItem(this._scene, this.weapon1));
        this.weapons2.on('pointerdown', ()=> this.setItem(this._scene, this.weapon2));
        this.weapons3.on('pointerdown', ()=> this.setItem(this._scene, this.weapon3));
        this.weapons4.on('pointerdown', ()=> this.setItem(this._scene, this.weapon4));	
        this.weapons5.on('pointerdown', ()=> this.setItem(this._scene, this.weapon5));	
        this.weapons6.on('pointerdown', ()=> this.setItem(this._scene, this.weapon6));
        this.weapons7.on('pointerdown', ()=> this.setItem(this._scene, this.weapon7));
        this.weapons8.on('pointerdown', ()=> this.setItem(this._scene, this.weapon8));
        this.weapons9.on('pointerdown', ()=> this.setItem(this._scene, this.weapon9));
    

    ////power ups
    
        this.items1.on('pointerdown', ()=> this.setItem(this._scene, this.item1));
        this.items2.on('pointerdown', ()=> this.setItem(this._scene, this.item2));
        this.items3.on('pointerdown', ()=> this.setItem(this._scene, this.item3));
        this.items4.on('pointerdown', ()=> this.setItem(this._scene, this.item4));
        this.items5.on('pointerdown', ()=> this.setItem(this._scene, this.item5));
        this.items6.on('pointerdown', ()=> this.setItem(this._scene, this.item6));
        this.items7.on('pointerdown', ()=> this.setItem(this._scene, this.item7));
        this.items8.on('pointerdown', ()=> this.setItem(this._scene, this.item8));
        this.items9.on('pointerdown', ()=> this.setItem(this._scene, this.item9));


    ////call resize

        System.app.ui.listen(this, 'PauseMenu', this.updatePosition);
...
//----------------------------------------------------------------------------------------
    ...
    //----------------------------- weapons
        ...
        this.weapons2_1.setVisible(this.inventory_page1 === true && this.weapons2_1.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_2.setVisible(this.inventory_page1 === true && this.weapons2_2.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_3.setVisible(this.inventory_page1 === true && this.weapons2_3.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_4.setVisible(this.inventory_page1 === true && this.weapons2_4.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_5.setVisible(this.inventory_page1 === true && this.weapons2_5.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_6.setVisible(this.inventory_page1 === true && this.weapons2_6.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_7.setVisible(this.inventory_page1 === true && this.weapons2_7.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_8.setVisible(this.inventory_page1 === true && this.weapons2_8.texture.key === Inventory3D.currentSelection ? true : false);
        this.weapons2_9.setVisible(this.inventory_page1 === true && this.weapons2_9.texture.key === Inventory3D.currentSelection ? true : false);
    ...
    //--------------------------- items
        ...
        this.item2_1.setVisible(this.inventory_page2 === true && this.item2_1.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_2.setVisible(this.inventory_page2 === true && this.item2_2.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_3.setVisible(this.inventory_page2 === true && this.item2_3.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_4.setVisible(this.inventory_page2 === true && this.item2_4.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_5.setVisible(this.inventory_page2 === true && this.item2_5.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_6.setVisible(this.inventory_page2 === true && this.item2_6.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_7.setVisible(this.inventory_page2 === true && this.item2_7.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_8.setVisible(this.inventory_page2 === true && this.item2_8.texture.key === Inventory3D.currentSelection ? true : false);
        this.item2_9.setVisible(this.inventory_page2 === true && this.item2_9.texture.key === Inventory3D.currentSelection ? true : false);
        ...
        { 
            ...
            this.itemsContainer.getAll().forEach((i: any) => i.setVisible(false));
        ...
        if (this.inventory_page2 === true)
        {
            ...
            this.itemsContainer.getAll().forEach((i: any) => i.setVisible(false));
            this.playerWeaponsContainer.getAll().forEach((e: any) => e.setVisible(false));
            this.inventoryTxt.setVisible(true);
...
//------------------------------------------------------------------------------
        ...
        setTimeout(()=> {
            ...
            if (scene.scene.settings.active === true)
            {
                if (System.isLandscape(scene)) 
                {
                    ...
                    scene.quitGameTxt.setPosition(80, 600);
                ...
                {    
                    ...
                    scene.quitGameTxt.setPosition(400, 850);
    ...
    private changePage(page: string): void
    {
        ...
        System.app.audio.play('sword_swipe', 0.5, false, this, 0);
        System.vibrate(20);
    ...
    private setItem (_scene: Scene3D, selection: string): void
    {
        Inventory3D.setItem(_scene, selection);
        System.app.audio.play('macaroni_ring', 1, false, this, 0);
    }

    //------------------------------ exit menu

    private exitPause (scene: any): void
    {
        System.app.audio.play('ring_echo', 1.1, false, this, 0);
        System.vibrate(20);
        this.scene.stop('Menu3D');
    }
    ...
    private exitGame (): void
    {
        ...
        this.scene.stop('Sandbox3D');
        this.scene.stop('SkeetShoot');
        System.app.events.quitGame(this._scene);
    }
