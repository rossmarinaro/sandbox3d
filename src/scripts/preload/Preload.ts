...
import { parseResources } from '../system/parser';
...
//----------------------------------------------------------------------------------------------------------------
	...
	private init(data: Phaser.Scenes.Systems | any): void
    {
        ...
        System.orientation.lock('portrait-primary');
...
//----------------------------------------------------------------------------------
    ...
    private async parse(scene: Phaser.Scene): Promise<void>
    {
        ...
        parseResources(scene, scene.cache.json.get('resources_3d'));
    }
